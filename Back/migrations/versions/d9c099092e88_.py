...
Revision ID: d9c099092e88
Revises: c590fc1b80d7
Create Date: 2025-05-09 19:11:43.312817
...
revision = 'd9c099092e88'
down_revision = 'c590fc1b80d7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('user_products', schema=None) as batch_op:
        batch_op.drop_constraint('user_products_ibfk_1', type_='foreignkey')
...
def downgrade():
    ...
    with op.batch_alter_table('user_products', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('user_products_ibfk_1', 'products', ['product_id'], ['id'])
