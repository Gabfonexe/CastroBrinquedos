<template>
  <div
    class="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat px-4 md:px-8"
    ...
    <div class="backdrop-blur-xl bg-white/10 border border-white/10 rounded-3xl shadow-2xl p-8 md:p-12 max-w-md w-full space-y-8">
      ...
      <div class="flex flex-col items-center gap-4">
        ...
        <p class="text-white/70 text-sm text-center">
          ...
          <a href="#" class="underline hover:text-white">Sign up</a>
        </p>
      </div>
      ...
      <form class="space-y-6">
        <div class="relative">
          ...
          <InputText
            ...
            class="w-full pl-12 py-3 rounded-full bg-white/10 text-white placeholder:text-white/60 border border-white/20 focus:ring-2 focus:ring-white/30 outline-none"
          />
        </div>

        <div class="relative">
          <i class="pi pi-lock absolute left-4 top-1/2 transform -translate-y-1/2 text-white/60"></i>
          <InputText
            type="password"
        ...
        <Button
          label="Sign In"
          class="w-full py-3 rounded-full bg-white/20 text-white font-medium hover:bg-white/30 border border-white/20 transition"
        />
      </form>
